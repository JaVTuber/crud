        ...
        <form class="contenedor_popup" method="POST">
            <table>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <?php echo "<a class='BotonesTeam' href=\"tabla_productos.php?pag=$pagina\">Cancelar</a>"; ?>&nbsp;
...
if (isset($_POST['btnregistrar'])) {
    ...
    echo "<script> alert('Producto registrado con exito: $pronom'); window.location='tabla_productos.php' </script>";
}
?>