...
<body>
    <div class="ContenedorPrincipal">
        ...
        if (isset($_POST['btnbuscar'])) {
            ...
            $sqlusu = mysqli_query($conn, "SELECT pro.id,pro.nombre,descripcion,precio,cat.nombre as categoria FROM productos pro, categoria_productos cat where pro.categoria_id=cat.id and descripcion like '" . $buscar . "%'");
        } else {
            $sqlusu = mysqli_query($conn, "SELECT pro.id,pro.nombre,descripcion,precio,cat.nombre as categoria FROM productos pro, categoria_productos cat where pro.categoria_id=cat.id ORDER BY pro.id ASC LIMIT " . (($pagina - 1) * $filasmax)  . "," . $filasmax);
        }
        ...
        <div class="ContenedorTabla">
            <form method="POST">
                ...
                <div class="ContBuscar">
                    <div style="float: left;">
                        <a href="tabla_productos.php" class="BotonesTeam">Inicio</a>
                    </div>
            ...
            <div style='text-align:right; color:#f3f3f3;'>
                <br>
        ...
        <div style="text-align:center">
            ...
            if (isset($_GET['pag'])) {
                if ($_GET['pag'] > 1) {
            ?>
                    <a class="BotonesTeam4" href="tabla_productos.php?pag=<?php echo $_GET['pag'] - 1; ?>">Anterior</a>
                <?php
                } else {
                ?>
            ...
            if (isset($_GET['pag'])) {
                ...
                ?>
                    <a class="BotonesTeam4" href="tabla_productos.php?pag=<?php echo $_GET['pag'] + 1; ?>">Siguiente</a>
                <?php
                } else {
                ?>
            ...
            ?>
                <a class="BotonesTeam4" href="tabla_productos.php?pag=2">Siguiente</a>
            <?php
            }
            ?>
        </div>
