    ...
    <body>
        <?php
            ...
            if(isset($_POST) && !empty($_POST)){
                $isbn = $libros->sanitize($_POST["isbn"]);
                        ...
                        <?php
                            ...
                            while($row = mysqli_fetch_object($lista)){
                                ...
                                <tr>
                                    ...
                                    <?php
                                        if ($libros->emp == true) {
                                            echo '<td>' . $cantidad . '</td><td><a class="boton" href="modificarLibro.php?isbn=<?php echo $isbn; ?>&mod"><i class="fa-regular fa-pen-to-square"></i></a>&ensp;<a class="boton" href="modificarLibro.php?isbn=<?php echo $isbn; ?>&del"><i class="fa-regular fa-trash-can"></i></a></td>';
                                        }
                                    ?>
                                </tr>
                                <?php
