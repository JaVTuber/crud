    ...
    <body>
        <?php
            ...
            if (isset($_GET["id"]) && (isset($_GET["mod"]) || isset($_GET["del"]))) {
                ...
                $res = $clientes->buscarElemento('cliente','ID', $id);
                        ...
                        <article class="delCliente">
                            ...
                            <main>
                                <form action="clientes.php" method="POST">
                                    ...
                                    <label for="del">ADVERTENCIA: ¿Estás seguro de borrar al usuario cliente <?php echo $nombre; ?>? Esta acción no se puede deshacer</label><br>
