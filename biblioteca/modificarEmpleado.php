    ...
    <body>
        <?php
            ...
            if (isset($_GET["id"]) && (isset($_GET["mod"]) || isset($_GET["del"]))) {
                ...
                $res = $empleados->buscarElemento('empleado','ID', $id);
                        ...
                        <article class="delEmpleado">
                            ...
                            <main>
                                <form action="empleados.php" method="POST">
                                    ...
                                    <label for="del">ADVERTENCIA: ¿Estás seguro de borrar al usuario empleado <?php echo $nombre; ?>? Esta acción no se puede deshacer</label>
                                    <a class="submit" href="empleados.php">Regresar</a>
